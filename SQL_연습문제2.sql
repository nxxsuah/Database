...
ALTER TABLE bank_customer CHANGE `c-no` c_no VARCHAR(20);
...
CREATE TABLE bank_transaction (
	t_no		int			auto_increment KEY NOT NULL,
...
ALTER TABLE bank_account CHANGE a_item_list a_item_dist varchar(2);

DROP TABLE bank_transaction;

#실습 2-3
INSERT INTO `bank_customer` VALUES ('102-22-51094', '부산의원', 2, '051-518-1010', '부산시 남구');
INSERT INTO `bank_customer` VALUES ('220-82-52237', '(주)한국전산', 2, '02-34-1045', '서울시 강서구');
...
INSERT INTO `bank_customer` VALUES ('830830-1000003', '선덕여왕', 1, '010-1234-1003', '서울시 마포구');
...
SELECT 
    ...
    MIN(t_amount) AS '작은 금액' FROM bank_transaction WHERE t_dist = 2;
...
#실습 2-22
SELECT t_dist, 
	COUNT(`t_no`) FROM `bank_transaction`GROUP BY t_dist;
